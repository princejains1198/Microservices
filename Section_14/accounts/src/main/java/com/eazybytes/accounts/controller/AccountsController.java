...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "API to get the build version information of the Accounts Service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<String> getBuildInfoFallback(Throwable throwable) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Accounts Service Build Version: " + "Unable to fetch build version at this time.");
    }

    @Operation(
            summary = "Get Java Version Information REST API",
            description = "API to get the java version information of the Accounts Service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<String> getJavaVersion() {
        return ResponseEntity.status(HttpStatus.OK).body("Accounts Service Java Version: " + environment.getProperty("JAVA_HOME"));
    }

    public ResponseEntity<String> getJavaVersionFallback(Throwable throwable) {
        return ResponseEntity.status(HttpStatus.OK).body("Accounts Service Java Version: " + "Unable to fetch java version at this time.");
    }
